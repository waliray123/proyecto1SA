...
@Value
public class RetrieveRoomResponse {
    ...
    public RetrieveRoomResponse(Room room) {
    ...
    public static RetrieveRoomResponse from(Room room) {
        return new RetrieveRoomResponse(
                room
        );
    }
